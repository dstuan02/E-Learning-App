    ...
    <View>
		...
		<View style={styles.container}>
			...
			<View style={styles.containerText}>
				...
				<Text style={styles.commentText}>This course is sogggggggggg good. Keep it going!</Text>
		...
		<View style={styles.container}>
			...
			<View style={styles.containerText}>
				<Text style={styles.displayName}>@tuandang</Text>
				<Text style={styles.commentText}>This course is so good. Keep it going!</Text>
