  ...
  return (
    <View className="bg-white h-full w-full">
        ...
        <View className="flex-row justify-around w-full absolute">
            ...
            <Animated.Image entering={FadeInUp.delay(300).duration(1000).springify().damping(3)} className="h-[160] w-[65]" source={require('./../Assets/Images/light.png')} />
        </View>
        ...
        <View className="h-full w-full flex justify-around pt-44 pb-10">
            ...
            <View className="flex items-center mx-4 space-y-4">
                ...
                <Animated.View entering={FadeInDown.delay(400).duration(1000).springify()} className="w-full">
                    <TouchableOpacity onPress={() => navigation.navigate('home')} className="w-full bg-sky-400 p-3 rounded-2xl mb-3">
                        <Text className="text-xl font-bold text-white text-center">Log In</Text>
                    </TouchableOpacity>
                </Animated.View>
